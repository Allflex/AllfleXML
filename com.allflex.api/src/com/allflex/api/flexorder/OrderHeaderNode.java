...
// Generated on: 2018.05.29 at 10:44:22 AM CDT 
//
 ...
 *         &lt;element name="UserDefined" type="{}UserDefinedNode" maxOccurs="unbounded" minOccurs="0"/>
...
public class OrderHeaderNode {
     ...
     * 
     */
    public List<UserDefinedNode> getUserDefined() {
        if (userDefined == null) {
            userDefined = new ArrayList<UserDefinedNode>();
        }
     ...
     * 
     */
    public List<OrderLineHeader> getOrderLineHeader() {
        if (orderLineHeader == null) {
            orderLineHeader = new ArrayList<OrderLineHeader>();
        }
